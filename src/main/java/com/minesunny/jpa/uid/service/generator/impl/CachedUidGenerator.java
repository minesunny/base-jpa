...
import com.minesunny.jpa.exception.UidGenerateException;
import com.minesunny.jpa.uid.BitsAllocator;
import com.minesunny.jpa.uid.UidProperties;
import com.minesunny.jpa.uid.buffer.BufferPaddingExecutor;
import com.minesunny.jpa.uid.buffer.RejectedPutBufferHandler;
import com.minesunny.jpa.uid.buffer.RejectedTakeBufferHandler;
import com.minesunny.jpa.uid.buffer.RingBuffer;
import com.minesunny.jpa.uid.service.generator.UidGenerator;
import com.minesunny.jpa.uid.service.worker.WorkerIdAssigner;
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.initRingBuffer();
        EntityCachedUidGenerator.setGenerator(this);
    ...
    protected List<Long> nextIdsForOneSecond(long currentSecond) {
        ...
        long firstSeqUid = bitsAllocator.allocate(currentSecond - getUidProperties().getEpochSeconds(), workerId, 0L);
